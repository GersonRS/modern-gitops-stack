...
module "efs" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-efs-csi-driver.git?ref=v3.2.0"
...
module "ebs" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-ebs-csi-driver.git?ref=v3.120"
