module "helloworld_apps" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-applicationset.git?ref=v3.0.0"
  # source = "../../modern-gitops-stack-module-applicationset"
  ...
  project_source_repo    = "https://github.com/GersonRS/modern-gitops-stack-helloworld-templates.git"
  ...
  generators = [
    {
      git = {
        repoURL  = "https://github.com/GersonRS/modern-gitops-stack-helloworld-templates.git"
        revision = "main"
