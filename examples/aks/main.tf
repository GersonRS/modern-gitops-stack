...
module "loki-stack" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-loki-stack.git//aks?ref=v1.1.0"
...
module "thanos" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-thanos.git//aks?ref=v1.1.0"
