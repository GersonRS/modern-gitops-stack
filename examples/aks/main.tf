...
module "argocd_bootstrap" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-argocd.git//bootstrap?ref=v2.6.1"
...
module "cert-manager" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-cert-manager.git//aks?ref=v2.5.0"
...
module "loki-stack" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-loki-stack.git//aks?ref=v2.5.0"
...
module "thanos" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-thanos.git//aks?ref=v2.5.0"
