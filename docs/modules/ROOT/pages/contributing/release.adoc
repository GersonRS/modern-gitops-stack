...
Every Modern Gitops Stack module contains a GitHub workflow that simply calls a centralized workflow.
...
[source,yaml]
----
include::examples$github_workflows/modules-release-please.yaml[]
----
